...
class CompressionReductionMethod : public ReductionMethod {
  ...
  public:
    ParameterizedCompression(double accuracy, double compression_cost_per_element,
...
public:
  ...
  [[nodiscard]] size_t get_reduced_variable_global_size(const Variable& /*var*/) const override { return 0; }
  ...
  [[nodiscard]] double get_flop_amount_to_reduce_variable(const Variable& /*var*/) const override { return 0.0; }
};
/// \endcond
} // namespace dtlmod
