...
The first publisher to call :cpp:func:`begin_transaction` marks that a new :ref:`Concept_Transaction` is in progress
...
:cpp:func:`close` function. The publishers first have to wait for the completion of the I/O activities started by the
...
publisher exports a summary of all the I/O operations performed during the lifetime of the Engine.
