...
FileEngine::FileEngine(const std::string& fullpath, Stream* stream)
    : Engine(fullpath, stream, Engine::Type::File), pub_activities_completed_(sg4::ConditionVariable::create())
{
